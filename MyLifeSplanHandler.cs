    ...
    class MyLifeSplanHandler: ILifeSpanHandler
    {
        ...
        bool ILifeSpanHandler.OnBeforePopup(IWebBrowser browserControl, IBrowser browser, IFrame frame, string targetUrl, string targetFrameName, WindowOpenDisposition targetDisposition, bool userGesture, IPopupFeatures popupFeatures, IWindowInfo windowInfo, IBrowserSettings browserSettings, ref bool noJavascriptAccess, out IWebBrowser newBrowser)
        {
            ...
            site.form.Invoke(new Action(() =>
            {
                ...
                site.form.tabControl1.SelectedTab = tab;
                Rectangle rect = tab.ClientRectangle;
                windowInfo.SetAsChild(tab.Handle, rect.Left, rect.Top, rect.Right, rect.Bottom);
            }));
        ...
        void ILifeSpanHandler.OnAfterCreated(IWebBrowser browserControl, IBrowser browser) {
            ...
            site.AfterCreated(browserControl, browser); 
        }
    }
}